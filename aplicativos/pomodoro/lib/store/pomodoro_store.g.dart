...
mixin _$PomodoroStore on _PomodoroStore, Store {
  ...
  late final _$minutoAtom = Atom(
    name: '_PomodoroStore.minuto',
    context: context,
  );
  ...
  late final _$cronometroAtom = Atom(
    name: '_PomodoroStore.cronometro',
    context: context,
  );

  @override
  Timer? get cronometro {
    _$cronometroAtom.reportRead();
    return super.cronometro;
  }

  @override
  set cronometro(Timer? value) {
    _$cronometroAtom.reportWrite(value, super.cronometro, () {
      super.cronometro = value;
    });
  }
  ...
  void _alterarIntervalo() {
    final _$actionInfo = _$_PomodoroStoreActionController.startAction(
      name: '_PomodoroStore._alterarIntervalo',
    );
    try {
      return super._alterarIntervalo();
    } finally {
      _$_PomodoroStoreActionController.endAction(_$actionInfo);
    }
  }
